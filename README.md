...
* Smoke tests:
  ...
  * `curl http://https://prodlist.20cyx0jkjm78.us-south.codeengine.appdomain.cloud/products` → returned product list (HTTP 200).
  * `curl http://https://dealerdetails.20cyx0jkjm78.us-south.codeengine.appdomain.cloud/prices?product_id=<id>` → returned dealer price list (HTTP 200).
* End-to-end UI tests:
